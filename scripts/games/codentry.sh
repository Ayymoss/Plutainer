#!/bin/bash
#
# Entry script for the `cod` family — every Plutonium, IW4x, BOIII and CoD4x
# game. Nothing in here is specific to one of them: the per-game facts
...
#             boiii.exe, or CoD4x's staged binary)
